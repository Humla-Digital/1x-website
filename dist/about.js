...
(() => {
  ...
  var require_jquery = __commonJS({
    "node_modules/.pnpm/jquery@3.5.1/node_modules/jquery/dist/jquery.js"(exports, module) {
      ...
      (function(global, factory) {
        ...
        var version = "3.5.1", jQuery = function(selector3, context3) {
        ...
        var Sizzle = (
           ...
           */
          function(window3) {
            var i, support3, Expr, getText2, isXML, tokenize, compile, select, outermostContext, sortInput, hasDuplicate, setDocument, document3, docElem, documentIsHTML, rbuggyQSA, rbuggyMatches, matches, contains, expando = "sizzle" + 1 * /* @__PURE__ */ new Date(), preferredDoc = window3.document, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), nonnativeSelectorCache = createCache(), sortOrder = function(a, b) {
              if (a === b) {
                hasDuplicate = true;
              }
              return 0;
            ...
            function Sizzle2(selector3, context3, results, seed) {
              ...
              if (!seed) {
                ...
                if (documentIsHTML) {
                  ...
                  if (support3.qsa && !nonnativeSelectorCache[selector3 + " "] && (!rbuggyQSA || !rbuggyQSA.test(selector3)) && // Support: IE 8 only
                  // Exclude object elements
                  (nodeType !== 1 || context3.nodeName.toLowerCase() !== "object")) {
            ...
            Expr = Sizzle2.selectors = {
              ...
              pseudos: {
                ...
                "not": markFunction(function(selector3) {
                  ...
                  return matcher[expando] ? markFunction(function(seed, matches2, _context5, xml) {
            ...
            function setMatcher(preFilter, selector3, matcher, postFilter, postFinder, postSelector) {
              ...
              return markFunction(function(seed, results, context3, xml) {
                var temp, i2, elem, preMap = [], postMap = [], preexisting = results.length, elems = seed || multipleContexts(
                  ...
                  []
                ), matcherIn = preFilter && (seed || !selector3) ? condense(elems, preMap, preFilter, context3, xml) : elems, matcherOut = matcher ? (
            ...
            select = Sizzle2.select = function(selector3, context3, results, seed) {
              var i2, tokens, token, type, find, compiled = typeof selector3 === "function" && selector3, match = !seed && tokenize(selector3 = compiled.selector || selector3);
              results = results || [];
              if (match.length === 1) {
        ...
        jQuery.fn.extend({
          find: function(selector3) {
            ...
            ret = this.pushStack([]);
            for (i = 0; i < len; i++) {
              jQuery.find(selector3, self[i], ret);
            }
  ...
  function ourMissionTypedAnim() {
    (0, import_jquery.default)(".section_our-mission").each(function() {
      const splitTextTimeline = gsapWithCSS.timeline({ paused: true, reversed: true }), aboutText = (0, import_jquery.default)(this).find(".d-light-44"), splitText = new SplitText(aboutText, { type: "words,chars" }), { chars } = splitText;
