...
(() => {
  ...
  init_live_reload();
  function initSoMeSlider() {
    const soMeSliderParams = {
    ...
    const soMeSlider = new Swiper(".some-slider", soMeSliderParams);
  }
  ...
  function discoverTags() {
    ...
    const popularTopics = (0, import_jquery.default)("#popular-topics");
