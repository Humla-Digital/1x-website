...
(() => {
  ...
  function ourMissionTypedAnim() {
    $(".section_typed-big-text").each(function() {
      const splitTextTimeline = gsapWithCSS.timeline({ paused: true, reversed: true }), aboutText = $(this).find("h2"), splitText = new SplitText(aboutText, { type: "words,chars" }), { chars } = splitText;
