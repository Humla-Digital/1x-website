...
(() => {
  ...
  function initOurAndroidsSlider() {
    ...
    $(".section_our-androids").each(function(index) {
      const triggerElement = $(this);
      const targets = gsapWithCSS.utils.toArray([
        ".our-androids-title",
  ...
  function embodiedLearningAnim() {
    $(".section_embodied-learning").each(function(index) {
      let targets1 = gsapWithCSS.utils.toArray([
        $(".embodied-learning-header-row").find("h2"),
        $(".embodied-learning-header-row").find("p")
      ]);
      let targets2 = gsapWithCSS.utils.toArray(".embodied-learning-card");
  ...
  function exploreCareersAnim() {
    $(".section_explore-careers").each(function() {
      ...
      const contentTarget = gsapWithCSS.utils.toArray([$(this).find("h2, p, .w-button")]);
      const tl = gsapWithCSS.timeline({
        scrollTrigger: {
          trigger: triggerElement,
          start: "top center"
