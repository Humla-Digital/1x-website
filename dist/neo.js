...
(() => {
    ...
    "node_modules/.pnpm/jquery@3.5.1/node_modules/jquery/dist/jquery.js"(exports, module) {
      ...
      (function(global, factory) {
        ...
        var Sizzle = (
           ...
           */
          function(window3) {
            var i, support2, Expr, getText2, isXML, tokenize, compile, select, outermostContext, sortInput, hasDuplicate, setDocument, document3, docElem, documentIsHTML, rbuggyQSA, rbuggyMatches, matches, contains, expando = "sizzle" + 1 * /* @__PURE__ */ new Date(), preferredDoc = window3.document, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), nonnativeSelectorCache = createCache(), sortOrder = function(a, b) {
              if (a === b) {
                hasDuplicate = true;
              }
              return 0;
            ...
            function Sizzle2(selector3, context3, results, seed) {
              ...
              if (!seed) {
                ...
                if (documentIsHTML) {
                  ...
                  if (support2.qsa && !nonnativeSelectorCache[selector3 + " "] && (!rbuggyQSA || !rbuggyQSA.test(selector3)) && // Support: IE 8 only
  ...
  function specsToggle() {
    ...
    (0, import_jquery2.default)("#imperial").on("click", function() {
      ...
      (0, import_jquery2.default)("#run-speed").text(imperialRunspeed);
    ...
    (0, import_jquery2.default)("#metric").on("click", function() {
      ...
      (0, import_jquery2.default)("#run-speed").text(metricRunspeed);
