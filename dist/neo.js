...
(() => {
  ...
  var _gsap = {
    ...
    registerEffect: function registerEffect(_ref3) {
      ...
      _effects[name] = function(targets2, vars, tl) {
        return effect(toArray(targets2), _setDefaults(vars || {}, defaults2), tl);
      };
      if (extendTimeline) {
  ...
  var androidScrollScene = $(".section_neo-features-scroll");
  var targets = gsapWithCSS.utils.toArray($(".is_pdp-android-scene"));
  var mm = gsapWithCSS.matchMedia();
  var neoScrollScene = gsapWithCSS.timeline({
    scrollTrigger: {
      markers: true,
